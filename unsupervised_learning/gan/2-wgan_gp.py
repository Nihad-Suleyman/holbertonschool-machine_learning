...
class WGAN_GP(keras.Model):
    ...
    def __init__(
        ...
        # Shape-related values used to generate interpolation coefficients.
        self.dims = self.real_examples.shape
        self.len_dims = len(self.dims)

        # Axes over which each sample's gradient norm is calculated.
        # Axis 0 is the batch dimension, so it is excluded.
        self.axis = tf.range(
            1,
            self.len_dims,
            delta=1,
        ...
        # Example:
        # real_examples shape = (1000, 28, 28, 1)
        # interpolation coefficient shape = (batch_size, 1, 1, 1)
    ...
    def get_real_sample(self, size=None):
        """Return a randomly selected batch of real samples."""
    ...
    def get_interpolated_sample(self, real_sample, fake_sample):
        """Generate samples interpolated between real and fake samples."""
    ...
    def gradient_penalty(self, interpolated_sample):
        """Calculate the critic's gradient penalty."""
    ...
    def train_step(self, useless_argument):
        ...
        # Train the critic several times.
        for _ in range(self.disc_iter):
            with tf.GradientTape() as tape:
                ...
                # Original Wasserstein critic loss.
